...
- [PR #2](https://github.com/hugosanga/jest-shard-workflow/pull/2): Demonstrates the coverage merge working. A new test is added, tests are split into shards, and coverage increases.
